...
import Program from '../image/program.svg'
import Aos from 'aos'
...
const Home = () => {
  ...
  return (
    ...
    <div className=''>
      ...
      <a className='hover:bg-transparent hover:text-amber-200 border p-2 rounded bg-slate-800 text-sm' href="https://drive.google.com/file/d/1ZOgIDZZimRwTRrzXIl2PsDPuW87Qebcz/view?usp=drive_link">Download my CV</a>
    </div>
    </div>

      <div className='sm:py-10'>
        <img className='' src={Program} width={400} alt="" />
    </div>
    </div>
    </div>
    <hr />
